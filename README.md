...
- Script de bash: Se automatizan distintas acciones ejecutando proyecto.sh en la carpeta script desde la consola con argumentos específicos, si se 
ejecuta sin argumentos se explicarán los argumentos válidos, se asume que se puede crear un pdf con LaTeX en la PC del usuario para la visualización 
del reporte y la presentación del proyecto

### Autor

Darío Hernández Cubilla

Grupo: C-113 (Para la evaluación de la Universidad)

## Sigue la descripción del proyecto por la facultad:
